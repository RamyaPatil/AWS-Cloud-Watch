        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a data-toggle="modal" href="#myModal" id="createAlarm" class="btn btn-primary" style="margin-left:100px">Create Alarm</a>
                    <a data-toggle="modal" href="#myOtherModal" id="deleteAlarm" class="btn btn-primary" style="margin-left:200px;display:none">Delete Alarm</a>
